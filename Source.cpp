...
#define APP_ID TEXT("") // https://e.developer.yahoo.co.jp Ç©ÇÁÉAÉvÉäÉPÅ[ÉVÉáÉìIDÇéÊìæÇµÇƒÇ≠ÇæÇ≥Ç¢ÅB
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case WM_CREATE:
		hEdit1 = CreateWindow(TEXT("EDIT"), TEXT("ìåãûìsêÁë„ìcãÊàÍíöñ⁄ÇPÅ|ÇP"), WS_VISIBLE | WS_CHILD | WS_BORDER, 10, 10, 512, 32, hWnd, 0, ((LPCREATESTRUCT)lParam)->hInstance, 0);
		CreateWindow(TEXT("BUTTON"), TEXT("éÊìæ"), WS_VISIBLE | WS_CHILD, 10, 50, 512, 32, hWnd, (HMENU)100, ((LPCREATESTRUCT)lParam)->hInstance, 0);
